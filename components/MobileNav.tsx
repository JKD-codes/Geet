...
export function MobileNav() {
  ...
  return (
    <nav className="md:hidden fixed bottom-0 w-full h-16 bg-card/90 backdrop-blur-md border-t border-white/5 flex items-center justify-around px-4 z-40 pb-safe">
